...
const details = [
  {
    label: "Email",
    value: "corporate@sastroutama.co.id",
  ...
  {
    label: "Telepon",
    value: "+62 21 5088 2020",
    icon: <path d="M5 4h4l2 5-3 2a12 12 0 006 6l2-3 5 2v4a2 2 0 01-2 2A16 16 0 013 6a2 2 0 012-2z" strokeLinecap="round" strokeLinejoin="round" />,
  },
  {
    label: "Kantor Pusat",
    value: "Jl. Jend. Sudirman Kav. 52, Jakarta Selatan",
      ...
      <div className="container-x">
        <div className="grid overflow-hidden rounded-[2rem] shadow-card ring-1 ring-slate-100 lg:grid-cols-5">
          ...
          <div className="relative bg-gradient-to-br from-primary via-primary-600 to-primary-800 p-10 text-white lg:col-span-2">
            <span className="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-1.5 font-heading text-xs font-semibold uppercase tracking-wider">
              Hubungi Kami
            </span>
            <h2 className="mt-6 font-heading text-3xl font-extrabold">Terhubung dengan Sastro Utama</h2>
            <p className="mt-4 text-primary-100">
              Untuk kemitraan distribusi, kerja sama media, hubungan investor, maupun
              pertanyaan produk — tim kami siap membalas dalam 1×24 jam kerja.
            </p>
