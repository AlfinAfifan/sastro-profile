      ...
      <div className="container-x grid gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-4">
              <div className="rounded-2xl bg-primary p-6 text-white shadow-soft">
                <p className="font-heading text-4xl font-extrabold">18+</p>
                <p className="mt-1 text-sm text-primary-100">Tahun berkarya</p>
              </div>
              <div className="rounded-2xl bg-primary-50 p-6">
                <p className="font-heading text-4xl font-extrabold text-primary">2.500</p>
                <p className="mt-1 text-sm text-slate-500">Karyawan di seluruh Indonesia</p>
              </div>
            </div>
        ...
        <div>
          ...
          <p className="mt-5 text-lg leading-relaxed text-slate-600">
            Berdiri sejak 2008, PT Sastro Utama Media Grup menaungi enam brand kosmetik
            dan perawatan diri yang melayani jutaan konsumen Indonesia. Kami mengelola
            seluruh rantai nilai — dari riset formula, produksi, pemasaran, hingga
            distribusi ke lebih dari 60.000 titik penjualan.
          </p>
